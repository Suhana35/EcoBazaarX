...
import { FiShoppingCart, FiUser, FiMenu, FiX, FiHome, FiPackage, FiLogIn, FiUserPlus, FiLogOut } from "react-icons/fi";
...
const AdminNavbar = () => {
  ...
  const navItems = [
    ...
    { path: '/userManagement', icon: FiUser, label: 'User Management' },
    { path: '/carbonManagement', icon: FaLeaf, label: 'Carbon Management' }
