...
function Layout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8fafc]">
      ...
      {/* {isUser && currentUser.role == "USER" && <Navbar />}
      {isUser && currentUser.role == "SELLER" && <SellerNavbar />}
      {isUser && currentUser.role =="ADMIN" && <AdminNavbar />} */}
...
// import SellerNavbar from './Seller/SellerNavbar'
// import SellerDashboard from './Seller/SellerDashboard'
// // import ProductForm from './Seller/AddProduct';
// import SellerOrders from './Seller/SellerOrders'
// import AddProduct from './Seller/AddProduct'
...
//   const adminRoutes = ["/admin", "/userManagement"];
//   const showAdminNavbar = adminRoutes.some(route => location.pathname.startsWith(route));
//   return (
//     <Authenticate>
//       <Router>
